...
import {edgeScreen} from '@/constants';

// base UI design
const baseWidth = 375;
const baseHeight = 812;

const horizontal = (size: number) => (edgeScreen.shorter / baseWidth) * size;
const vertical = (size: number) => (edgeScreen.longer / baseHeight) * size;
